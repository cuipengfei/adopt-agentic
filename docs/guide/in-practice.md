...
这一节不做全面操作手册——那是各工具自己的文档该干的事。这里只挑**高杠杆操作**：理解概念后 10 分钟内能动手、立刻见效的东西。

## 写好你的 System Instructions

> 对应概念：[System Instructions](/guide/system-instructions)、[知识喂养](/guide/knowledge-feeding)

System Instructions 是你能动的最强杠杆——不写代码、不装插件，一个文件改变 Agent 的整体行为。
...
如果复述偏了，在它写任何代码之前就能纠正。这比写完 500 行代码再推倒重来便宜太多。

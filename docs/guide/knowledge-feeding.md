...
规则层的规则会互相矛盾——团队之前定的"所有函数必须写 JSDoc"可能早被默认放弃了，但规则文件里还写着，agent 每次都照做。

能力层的 Skill 会和新需求冲突——之前加载的代码风格 Skill 可能跟当前项目的规范打架。

项目层的文档会腐烂——README 写着旧的技术方案，项目早就换了新做法，但没人更新文档。

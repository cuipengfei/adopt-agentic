...
每个位置的本质都是一样的：**你的决策 → 上下文变化 → Agent 行为改变。**
...
**立即打断。** Agent 从一开始就理解错了你的意图，或者正在执行明显错误的操作。越早打断，沉没成本越低。

**让它跑完再改。** 整体方向对，但细节有瑕疵。让它完成，你再基于产出修正。保留了 Agent 的大部分工作成果。

**放弃当前会话，重来。** 上下文已经被严重污染，Agent 陷入无法恢复的混乱。开一个新的、干净的会话，用更清晰的指令重新开始——比在泥潭里挣扎更高效。这不是浪费，这是止损。
...
Agent 放大你的能力。但如果你不维护自己的理解，它放大的就是你的无知。
